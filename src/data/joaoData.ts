    ...
    'operacoes-fracoes': {
      ...
      sections: [
        ...
        },
        {
          ...
          type: 'example',
          title: 'Exemplo resolvido',
          body: 'Calcule 1/4 + 1/6.\n\nPasso 1 — denominador comum: 4 × 6 = 24 (ou o MMC, que é 12)\nPasso 2 — usando 12: 1/4 = 3/12 e 1/6 = 2/12\nPasso 3 — somar: 3/12 + 2/12 = 5/12',
        },
        {
          id: 'sec-5',
          type: 'example',
          title: 'Outro exemplo resolvido',
          body: 'Calcule 3/5 × 2/7.\n\nPasso 1 — multiplicar numeradores: 3 × 2 = 6\nPasso 2 — multiplicar denominadores: 5 × 7 = 35\nResultado: 6/35',
        },
        {
          id: 'sec-6',
          type: 'attention',
  ...
  questionSets: {
    ...
    'pratica-operacoes-fracoes': [
      ...
      },
      {
        ...
        correctOptionId: 'a',
        explanation: 'Denominador comum 6: 1/3 = 2/6. Então 2/6 + 1/6 = 3/6 = 1/2.',
        stepByStep: ['1/3 = 2/6', '2/6 + 1/6 = 3/6', '3/6 simplifica para 1/2'],
      },
      {
        id: 'of3',
        subject: 'matematica',
        ...
        correctOptionId: 'c',
        explanation: '1×2=2 e 2×3=6, então 2/6, que simplifica para 1/3.',
        stepByStep: ['Numerador: 1 × 2 = 2', 'Denominador: 2 × 3 = 6', '2/6 simplifica para 1/3'],
      },
      {
        id: 'of4',
        subject: 'portugues',
      ...
      },
      {
        ...
        stepByStep: ['Mesmo denominador: mantém 4', '3 − 1 = 2', '2/4 simplifica para 1/2'],
      },
      {
        id: 'of6',
        subject: 'matematica',
        ...
        stepByStep: ['João + Maria: 3/8 + 2/8 = 5/8', 'Total da pizza: 8/8', 'Restante: 8/8 − 5/8 = 3/8'],
      },
    ],
